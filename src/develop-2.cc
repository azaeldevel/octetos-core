...
bool lexing(const char* input)
{
	...
	semver_tt.acceptable(build,'a',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'b',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'c',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'d',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'e',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'f',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'g',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'h',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'i',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'j',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'k',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'l',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'m',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'n',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'o',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'p',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'q',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'r',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'s',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'t',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'u',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'v',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'w',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'x',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'y',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'z',oct::core::v3::lc::semver_tokens::stage,build);	
	semver_tt.acceptable(build,'A',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'B',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'C',oct::core::v3::lc::semver_tokens::stage,build);
	semver_tt.acceptable(build,'D',oct::core::v3::lc::semver_tokens::stage,build);
