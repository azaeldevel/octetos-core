...
public:
	...
	void init()
	{
		...
		Status prefixNumber = 1;
		TT<Symbol,Token,Status,TT_BASE>::initial(prefixNumber);	
		Status prefixString = 2;
		TT<Symbol,Token,Status,TT_BASE>::initial(prefixString);	
		Status number = 3;
		...
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixNumber,'0',number);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixNumber,'1',number);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixNumber,'2',number);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixNumber,'3',number);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixNumber,'4',number);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixNumber,'5',number);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixNumber,'6',number);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixNumber,'6',number);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixNumber,'8',number);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixNumber,'9',number);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixNumber,'+',number);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixNumber,'-',number);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixNumber,'.',number);

		
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'a',string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'b',string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'c',string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'d',string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'e',string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'f',string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'g',string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'h',string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'i',string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'j',string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'k',string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'l',string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'m',string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'n',string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'o',string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'p',string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'q',string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'r',string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'s',string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'t',string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'u',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'v',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'w',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'x',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'y',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'z',oct::core::v3::lc::tokens::string,string);	
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'A',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'B',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'C',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'D',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'E',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'F',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'G',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'H',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'I',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'J',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'K',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'L',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'M',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'N',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'O',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'P',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'Q',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'R',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'S',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'T',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'U',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'V',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'W',oct::core::v3::lc::tokens::string,string);
		TT<Symbol,Token,Status,TT_BASE>::prefix(prefixString,'X',oct::core::v3::lc::tokens::string,string);
